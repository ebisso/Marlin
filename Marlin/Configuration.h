...
#define STRING_CONFIG_H_AUTHOR "( Kossel MINI)" 
...
#define DISABLE_E true //针对所有挤出机有效
...
#define ENABLE_AUTO_BED_LEVELING // 是否开启自动调平功能 
  ...
  #define DELTA_PROBABLE_RADIUS (DELTA_PRINTABLE_RADIUS-47)
  ...
  #define XY_TRAVEL_SPEED 4000         //执行自动调平移动的速度，增大速度增加，减小速度降低
