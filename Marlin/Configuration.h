...
#define STRING_CONFIG_H_AUTHOR "(ebisso, default config)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 100, 150}  // 200 steps per rotation * 16 (microstepping) / 2mm belt pitch / 16 sprocket teeth
